...
export default {  
  ...
  methods: {
    start() {
      ...
      const demoButtons = document.querySelectorAll('.js-modify');
      demoButtons.forEach(button => {
        button.addEventListener('click', this.toggleEffect);
      });
    ...
    toggleEffect(event) {
      ...
      target.dataset.effect = event.currentTarget.dataset.effect;
